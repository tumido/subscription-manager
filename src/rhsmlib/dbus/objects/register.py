...
class DomainSocketRegisterDBusObject(base_object.BaseObject):
    ...
    def build_uep(self, options):
        ...
        connection_info['host'] = options.setdefault('host', server_sec['hostname'])
        connection_info['ssl_port'] = options.setdefault('port', server_sec.get_int('port'))
        connection_info['handler'] = options.setdefault('handler', server_sec['prefix'])
        connection_info['proxy_hostname_arg'] = options.setdefault('proxy_hostname', server_sec['proxy_hostname'])
        connection_info['proxy_port_arg'] = options.setdefault('proxy_port', server_sec.get_int('proxy_port'))
        connection_info['proxy_user_arg'] = options.setdefault('proxy_user', server_sec['proxy_user'])
        connection_info['proxy_password_arg'] = options.setdefault('proxy_password', server_sec['proxy_password'])
        connection_info['no_proxy_arg'] = options.setdefault('no_proxy', server_sec['no_proxy'])
    ...
    def validate_options(self, options):
        ...
        if options.setdefault('activation_keys', None):
